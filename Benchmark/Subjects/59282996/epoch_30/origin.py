...
# cus_dataset = {}
# cus_dataset['x'] = X_batches_train
# cus_dataset['y'] = y_batches_train
# cus_dataset['x_val'] = X_batches_test
# cus_dataset['y_val'] = y_batches_test

# model.save("./model.h5")
# config = pack_train_config(opt='sgd', loss='sparse_categorical_crossentropy', dataset='customized', epoch=10, batch_size=20, lr=0.01, callbacks=[])
