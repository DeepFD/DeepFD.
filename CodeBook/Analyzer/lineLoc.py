...
def lineLoc(pred_voting, subject_name):
    ...
    print("working on subject: ", subject_name)
    base_dir = "./Evaluations/Subjects"
    ...
    for mutant_dir in os.listdir(subject_dir):
        ...
        try:
            ...
            print("Fault diagnosis and localization powered by DeepFD:")
            for lid, label_index in enumerate(buggy_label, 1):
                name = label_name[label_index]

                print("Fault {}: [{}], Line numbers: [{}]".format(lid, name, line_no[name]))
